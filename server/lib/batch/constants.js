...
export const availableTasks = [
  ...
  { label: "领取每周免费礼包", value: "weeklyFreeGift" },
  { label: "领取周一免费礼包", value: "mondayFreeGift" },
  { label: "每周免费抽卡", value: "gachaFreeDrawWeekly" },
  { label: "PK房间预约", value: "batchPkRoomAppoint" },
  { label: "黑市购买清单", value: "blackMarketPurchaseList" },
  { label: "积分好礼领取", value: "charge_claimaddup_rewards" },
  { label: "周免费礼领取", value: "claim_recruit_welfare" },
  { label: "怪异塔奖励领取", value: "claim_weird_tower_all" },
  { label: "开碎片礼包", value: "batchOpenFragmentPacks" },
  { label: "宝箱达标奖励", value: "batchClaimBoxWeeklyRewards" },
];
